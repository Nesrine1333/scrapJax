...
with requests.session() as s :
        ...
        while True :
                ...
                index = [header.index(i) for i in ['code','status']]
                # print(index)
                ...
                with open("output3.csv", "a", newline="", encoding="utf-8") as csv_file:  # Use "a" to append to the file
                    ...
                    for entry in data:
                            ...
                            csv_writer.writerow({'code': l[index[0]], 'status': status_value})
                             # Check if 'libelle' is "en attente" and increment the count
                            if status_value == 'En attente':
                                en_attente_count += 1
                            elif status_value =='Reçu par l`expediteur':
                                  expi+=1
